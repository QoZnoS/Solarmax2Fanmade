package Game
{
   ...
   public class SpeedButton extends Sprite
   {
      ...
      public function changeSpeed():void
      {
         ...
         buttonArray[1].x = buttonArray[2].x - buttonArray[1].width * 0.75;
         buttonArray[1].alpha = 0.6;
         if (ui.speedMult > 0.125 && ui.speedMult < 8)
         {
            buttonArray[0].alpha = 0.3;
            buttonArray[2].alpha = 0.3;
         }
         else if (ui.speedMult == 0.125)
         {
            buttonArray[0].alpha = 0.8;
            buttonArray[2].alpha = 0.3;
         }
         else if (ui.speedMult == 8)
         {
            buttonArray[0].alpha = 0.3;
            buttonArray[2].alpha = 0.8;
         }
      }
   }
}
