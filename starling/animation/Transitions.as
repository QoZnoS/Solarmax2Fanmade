package starling.animation
{
   ...
   public class Transitions
   {
      ...
      protected static function easeInElastic(param1:Number) : Number
      {
         ...
         _loc2_ = (_loc4_ = 0.3) / 4;
         _loc3_ = param1 - 1;
         return -1 * Math.pow(2,10 * _loc3_) * Math.sin((_loc3_ - _loc2_) * 6.283185307179586 / _loc4_);
      }
      ...
      protected static function easeOutElastic(param1:Number) : Number
      {
         ...
         _loc3_ = 0.3;
         _loc2_ = _loc3_ / 4;
         return Math.pow(2,-10 * param1) * Math.sin((param1 - _loc2_) * 6.283185307179586 / _loc3_) + 1;
      }
