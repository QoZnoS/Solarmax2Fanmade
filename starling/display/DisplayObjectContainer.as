package starling.display
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function addChildAt(param1:DisplayObject, param2:int) : DisplayObject
      {
         ...
         var _loc4_:int = int(mChildren.length);
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:int = int(mChildren.length);
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      override public function getBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc4_:int;
         if((_loc4_ = int(mChildren.length)) == 0)
         {
         ...
         {
            _loc6_ = 1.7976931348623157e+308;
            var _loc5_:Number = -1.7976931348623157e+308;
            _loc8_ = 1.7976931348623157e+308;
      ...
      override public function hitTest(param1:Point, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc7_:int;
         _loc8_ = (_loc7_ = int(mChildren.length)) - 1;
         while(_loc8_ >= 0)
         {
            ...
            if(_loc6_ = _loc3_.hitTest(sHelperPoint,param2))
            {
               return _loc6_;
            }
            _loc8_--;
      ...
      override public function render(param1:RenderSupport, param2:Number) : void
      {
         var _loc8_:int = 0;
         var _loc3_:DisplayObject = null;
         var _loc7_:FragmentFilter = null;
         var _loc5_:Number = param2 * this.alpha;
         var _loc6_:int = int(mChildren.length);
      ...
      internal function getChildEventListeners(param1:DisplayObject, param2:String, param3:Vector.<DisplayObject>) : void
      {
         ...
         if(_loc4_)
         {
            _loc6_ = int((_loc5_ = _loc4_.mChildren).length);
            _loc7_ = 0;
            while(_loc7_ < _loc6_)
            {
