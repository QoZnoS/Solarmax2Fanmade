package starling.display
{
   ...
   public class Image extends Quad
   {
      ...
      {
         mVertexData.setTexCoords(0,0.25,0);
         mVertexData.setTexCoords(1,0.75,0);
         mVertexData.setTexCoords(2,0.25,1);
         mVertexData.setTexCoords(3,0.75,1);
      }
      
      public function vertexChanged() : void
      {
         onVertexDataChanged();
      }
