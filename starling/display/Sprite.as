package starling.display
{
   ...
   public class Sprite extends DisplayObjectContainer
   {
      ...
      private function disposeFlattenedContents() : void
      {
         ...
         {
            _loc2_ = 0;
            _loc1_ = int(mFlattenedContents.length);
            while(_loc2_ < _loc1_)
            {
      ...
      public function getClipRect(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         ...
         var _loc7_:Number = 1.7976931348623157e+308;
         var _loc6_:Number = -1.7976931348623157e+308;
         var _loc10_:Number = 1.7976931348623157e+308;
      ...
      override public function render(param1:RenderSupport, param2:Number) : void
      {
         ...
         if(mClipRect)
         {
            if((_loc7_ = param1.pushClipRect(getClipRect(stage,sHelperRect))).isEmpty())
            {
               param1.popClipRect();
               return;
            }
         ...
         if(mFlattenedContents || mFlattenRequested)
         {
            ...
            _loc8_ = int(mFlattenedContents.length);
            ...
            while(_loc9_ < _loc8_)
            {
               _loc3_ = (_loc6_ = mFlattenedContents[_loc9_]).blendMode == "auto" ? param1.blendMode : _loc6_.blendMode;
