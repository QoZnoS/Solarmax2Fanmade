package starling.events
{
   ...
   public class TouchProcessor
   {
      ...
      {
         var _loc4_:Touch;
         if((_loc4_ = getCurrentTouch(0)) == null || _loc4_.phase != "hover")
         {
            return;
         }
         ...
         var _loc7_:Number;
         if((_loc7_ = Math.min(_loc5_,_loc2_,_loc9_,_loc8_)) == _loc5_)
         {
            _loc1_ = -1;
         }
      ...
      {
         var _loc8_:Touch;
         if((_loc8_ = getCurrentTouch(param1)) == null)
         {
      ...
      private function monitorInterruptions(param1:Boolean) : void
      {
         ...
         try
         {
            ...
            {
               _loc2_.removeEventListener("activate",onInterruption);
            }
         }
         catch(e:Error)
         {
