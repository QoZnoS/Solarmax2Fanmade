package starling.events
{
   ...
   public class TouchEvent extends Event
   {
      ...
      public function getTouches(param1:DisplayObject, param2:String = null, param3:Vector.<Touch> = null) : Vector.<Touch>
      {
         ...
         var _loc5_:Vector.<Touch>;
         var _loc7_:int = int((_loc5_ = data as Vector.<Touch>).length);
         _loc9_ = 0;
         while(_loc9_ < _loc7_)
         {
            _loc8_ = (_loc4_ = _loc5_[_loc9_]).isTouching(param1);
      ...
      public function getTouch(param1:DisplayObject, param2:String = null, param3:int = -1) : Touch
      {
         ...
         var _loc5_:int;
         if((_loc5_ = int(sTouches.length)) > 0)
         {
            _loc4_ = null;
            if(param3 < 0)
            {
      ...
      internal function dispatch(param1:Vector.<EventDispatcher>) : void
      {
         ...
         {
            _loc3_ = int(bubbles ? param1.length : 1);
            _loc2_ = target;
