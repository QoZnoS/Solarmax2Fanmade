package com.greensock.core
{
   ...
   public class Animation
   {
      ...
      public function Animation(param1:Number = 0, param2:Object = null)
      {
         ...
         var _loc4_:* = param1 || false;
         _totalDuration = param1 || false;
         _duration = _loc4_;
         _delay = Number(this.vars.delay) || false;
         _timeScale = 1;
         _totalTime = _time = 0;
         data = this.vars.data;
         _rawPrevTime = -1;
      ...
      public function timeScale(param1:Number = NaN) : *
      {
         ...
         {
            _loc3_ = Boolean(_pauseTime) || _pauseTime == 0 ? _pauseTime : _timeline._totalTime;
      ...
      public function paused(param1:Boolean = false) : *
      {
         ...
         if(param1 != _paused)
         {
            if(_timeline)
            {
               ...
               _pauseTime = param1 ? _loc3_ : NaN;
               _paused = param1;
               _active = !param1 && _totalTime > 0 && _totalTime < _totalDuration;
               if(!param1 && _loc4_ != 0 && _initted && duration() !== 0)
               {
                  render(_timeline.smoothChildTiming ? _totalTime : (_loc3_ - _startTime) / _timeScale,true,true);
               }
            }
         }
         if(_gc && !param1)
